...
-- Add category_id column to machine_expenses table
ALTER TABLE machine_expenses ADD COLUMN IF NOT EXISTS category_id UUID REFERENCES expense_categories(id);
